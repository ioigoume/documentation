...
Assurance Profiles which distinguish between three LoA levels, similarly to the
...
Moreover, EGI Check-in follows the [REFEDS Assurance framework](https://wiki.refeds.org/display/ASS/REFEDS+Assurance+Framework+ver+1.0).
